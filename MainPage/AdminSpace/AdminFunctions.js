...
function AdminView(ViewOPC){
    ...
    windows.forEach(item => console.log(item));
    windows.forEach(window.style.display = 'none');
    if(windows[ViewOPC]){
...
//   fetch('../Employee-search/Main-page.html')
//     .then(response => {
//       // Verificamos que la petición fue exitosa
//       if (!response.ok) {
//         throw new Error('No se pudo cargar la vista de usuario.');
//       }
//       // Convertimos la respuesta a texto
//       return response.text();
//     })
//     .then(html => {
//       // Inyectamos el HTML recibido dentro de nuestro contenedor
//       contenedor.innerHTML = html;
//     })
//     .catch(error => {
//       console.error('Error al cargar el componente:', error);
//       contenedor.innerHTML = '<p>Error al cargar la vista. Inténtalo de nuevo.</p>';
//     });
// }
